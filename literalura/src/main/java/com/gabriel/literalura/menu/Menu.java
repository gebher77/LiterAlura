package com.edielson.literalura.menu;

import com.edielson.literalura.model.*;
import com.edielson.literalura.repository.BookRepository;
import com.edielson.literalura.repository.PersonRepository;
import com.edielson.literalura.service.GetBook;
...
public class Menu {
    ...
    private List<com.edielson.literalura.model.Person> authors = new ArrayList<>();

    @Autowired
    private com.edielson.literalura.repository.BookRepository bookRepository;
